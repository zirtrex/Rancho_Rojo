...
class AuthController extends AbstractActionController
{
    ...
    public function indexAction()
    {
        ...
        if ($request->isPost()) {
            ...
            $secret = '6LerdmEUAAAAAHdcbm0e-6wLtyEqs_5D08dIts7s';
            ...
            if ($resp->isSuccess()) {
                ...
                $form->get('ingresar')->setMessages(array(
                    'No ha sobrepasado nuestros filtros de seguridad, vuelva a intentarlo por favor.',
                    'Verifique que tenga javascript activo.'
                ));
            }
        }
